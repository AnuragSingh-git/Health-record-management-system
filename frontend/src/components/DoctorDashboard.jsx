...
export const DoctorDashboard = () => {
  ...
  const searchhandle = async () => {
    try {
      const patientdetails = await api.get(
  ...
  const requestdetailhandlepatient = (id) => {
    navigate(`/request/${id}`);
  }

  const fetchPatients = async () => {
  try {
    const res = await api.get("/api/request/getrequestdoctor");

    setpatients(res.data.requestgot);
        ...
        <div className="w-62.5 bg-white border-r p-6 flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="space-y-3">
              <button onClick={()=>{setactiveTab("dashboard")}} className="w-full text-left p-3 rounded-xl bg-blue-100">
                Dashboard
              </button>

              <button onClick={fetchPatients} className="w-full text-left p-3 rounded-xl hover:bg-gray-100">
                Patients
              </button>
            ...
            <div className="w-full max-w-5xl">
              ...
              <div className="mb-8">
                ...
                <p className="text-center text-gray-500 mt-2">
                  Approved • Pending • Rejected Requests
                </p>
                ...
                {patients.length > 0 ? (
                  ...
                  <div className="space-y-5">
                    ...
                    {patients.map((patient, index) => (
                      ...
                      <div
                        key={index} onClick={()=>{if(patient.status=="approved"){requestdetailhandlepatient(patient.patientid._id)}}}
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 mt-1">
                            User ID: {patient.patientid.username}
                          </p>
                  ...
                  <div className="text-center py-20">
                    ...
                    <p className="text-gray-500 mt-2">
                      Approved, pending, or rejected requests will appear here
                    </p>
